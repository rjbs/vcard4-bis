...
normative:
  ...
  xfn:
    ...
    author:
      ...
      - name: "Matt Mullenweg"
      - name: "Eric Meyer"
    target: http://gmpg.org/xfn/11

informative:
  IANA-TZ:
    title: "IANA Procedures for Maintaining the Timezone Database"
    author:
      - name: "Eliot Lear"
      - name: "Paul Eggert"
    date: 2011-05
  ...
  ISO9070:
    title: "Information Processing - SGML support facilities - Registration Procedures for Public Text Owner Identifiers"
    author:
      org: "International Organization for Standardization"
    date: 1991-04
    seriesinfo:
  ...
  TZ-DB:
    ...
    author:
      - name: "Arthur David Olson"
    target: ftp://elsie.nci.nih.gov/pub/
  vCard21:
    title: "vCard - The Electronic Business Card Version 2.1"
    author:
...
Special notes
: This property is based on the X.520 Telephone Number
...
Special notes
: The "geo" URI scheme {{!RFC5870}} is particularly well
...
Special notes
: This property is based on the X.520 Business Category
...
Special notes
: The property is based on the X.520 Description
  attribute {{CCITT.X520.1988}}.
...
Purpose
: To specify the URI for the busy time associated with the
  object that the vCard represents.
...
Special notes
: Where multiple FBURL properties are specified, the
...
Purpose
: To specify the calendar user address {{!RFC5545}} to which a
...
Special notes
: Where multiple CALADRURI properties are specified,
...
Purpose
: To specify the URI for a calendar associated with the
...
Special notes
: Where multiple CALURI properties are specified, the
...
Namespace
: Empty for the global namespace, "VND-NNNN-" for a vendor-
...
Description
: Any special notes about the property, how it is to be
  used, etc.
...
Purpose
: The purpose of the parameter.  Give a short but clear
  description.

Description
: Any special notes about the parameter, how it is to be
  used, etc.

Format definition
: The ABNF for the parameter definition needs to be
  specified.

Example(s)
: One or more examples of instances of the parameter need
  to be specified.
...
Purpose
: The purpose of the value type.  Give a short but clear
  description.

Description
: Any special notes about the value type, how it is to be
  used, etc.

Format definition
: The ABNF for the value type definition needs to be
  specified.

Example(s)
: One or more examples of instances of the value type need
  to be specified.
...
Purpose
: The purpose of the value.  Give a short but clear
  description.

Conformance
: The vCard properties and/or parameters that can take
  this value needs to be specified.

Example(s)
: One or more examples of instances of the value need to
  be specified.
...
Purpose
: It means that the related entity is the direct hierarchical
  superior (i.e., supervisor or manager) of the entity this vCard
  represents.

Conformance
: This value can be used with the "TYPE" parameter
